        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<div >
					<button style = "width:500px;" class ="btn bg-primary text-gray-100" type="button" onclick="adminMainPage()">관리자권한 접속</button>
					</div>
...
function adminMainPage(){
	var inputPw = prompt("비밀번호 입력"); //(값::String::사용자가 입력한 값)
	//var confirmVal = confirm("확인"); //(값:: boolean::사용자가 선택한 값)
	
	console.log("adminMainPage출력");
	location.href="adminMainpage?inputPw="+inputPw;
}
